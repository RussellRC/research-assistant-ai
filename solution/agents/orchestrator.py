...
async def execute_research_workflow(
    ...
    # ========================================================================
    query_result = {
        "quality_score": fact_check.get('credibility_score', 0),
    ...
    print(f"   • Query: {query}")
    print(f"   • Domain: {classification.get('domain', 'unknown')}")
    print(f"   • Sources Found: {query_result['sources_found']}")
    print(f"   • Research Iterations: {query_result['iterations']}")
    print(f"   • Credibility Score: {fact_check.get('credibility_score', 0):.2f}")
    ...
    evaluator.evaluate_query_result(query_result, execution_time)
